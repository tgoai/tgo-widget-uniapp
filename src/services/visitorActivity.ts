...
export interface VisitorActivityCreateRequest {
  id?: string | null
...
export interface VisitorActivityCreateResponse {
  id: string
...
export async function recordVisitorActivity(params: {
  ...
  if (!apiBase)
    throw new Error('[Activity] Missing apiBase')
  if (!visitorId)
    throw new Error('[Activity] Missing visitorId')
  ...
  if (durationSeconds != null)
    (body as any).duration_seconds = durationSeconds
